  ...
  console.table([
    {
      ...
      "Input Amount": web3Utils.fromWei(inputAmount, "Ether"),
      "Uniswap Return": web3Utils.fromWei(uniswapResult, "Ether"),
      "Kyber Expected Rate": web3Utils.fromWei(
...
async function monitorPrice() {
  ...
  try {
    ...
    await checkPair({
      ...
      inputAmount: web3Utils.toWei("1", "ETHER"),
    });
